...
class TrophySellerDetail extends StatefulWidget {
  dynamic service;
  TrophySellerDetail({this.service});

  @override
  _TrophySellerDetailState createState() => _TrophySellerDetailState();
}

class _TrophySellerDetailState extends State<TrophySellerDetail> {
