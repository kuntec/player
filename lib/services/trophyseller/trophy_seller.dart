...
import 'package:player/services/trophyseller/my_trophy_seller.dart';
import 'package:player/services/trophyseller/trophy_seller_details.dart';
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => TrophySellerDetail(
              service: service,
            ),
          ),
        );
