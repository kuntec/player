...
import 'package:player/services/sportmarket/edit_sport_market.dart';
...
class MySportMarket extends StatefulWidget {
  dynamic serviceId;
  MySportMarket({this.serviceId});

  @override
  _MySportMarketState createState() => _MySportMarketState();
}

class _MySportMarketState extends State<MySportMarket> {
  @override
          ...
          CupertinoDialogAction(
            ...
            onPressed: () async {
              ...
              var result = await Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => EditSportMarket(
