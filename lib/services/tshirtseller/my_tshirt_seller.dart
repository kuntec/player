...
class MyTshirtSeller extends StatefulWidget {
  dynamic serviceId;
  MyTshirtSeller({this.serviceId});

  @override
  _MyTshirtSellerState createState() => _MyTshirtSellerState();
}

class _MyTshirtSellerState extends State<MyTshirtSeller> {
  @override
