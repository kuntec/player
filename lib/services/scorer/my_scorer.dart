...
class MyScorer extends StatefulWidget {
  dynamic serviceId;
  MyScorer({this.serviceId});

  @override
  _MyScorerState createState() => _MyScorerState();
}

class _MyScorerState extends State<MyScorer> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("My Scorer"),
      ),
