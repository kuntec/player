...
import 'package:player/services/personalcoach/edit_personal_coach.dart';
...
class MyPersonalCoach extends StatefulWidget {
  dynamic serviceId;
  MyPersonalCoach({this.serviceId});

  @override
  _MyPersonalCoachState createState() => _MyPersonalCoachState();
}

class _MyPersonalCoachState extends State<MyPersonalCoach> {
  @override
          ...
          CupertinoDialogAction(
            ...
            onPressed: () async {
              ...
              var result = await Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => EditPersonalCoach(
