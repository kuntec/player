...
class ManufacturerDetails extends StatefulWidget {
  dynamic service;
  ManufacturerDetails({this.service});

  @override
  _ManufacturerDetailsState createState() => _ManufacturerDetailsState();
}

class _ManufacturerDetailsState extends State<ManufacturerDetails> {
