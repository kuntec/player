...
import 'package:player/services/commentator/edit_commentator.dart';
...
class MyCommentator extends StatefulWidget {
  dynamic serviceId;
  MyCommentator({this.serviceId});

  @override
  _MyCommentatorState createState() => _MyCommentatorState();
}

class _MyCommentatorState extends State<MyCommentator> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("My Commentator"),
      ),
          ...
          CupertinoDialogAction(
            ...
            onPressed: () async {
              ...
              var result = await Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => EditCommentator(
