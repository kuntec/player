...
class EditCommentator extends StatefulWidget {
  dynamic service;

  EditCommentator({required this.service});

  @override
  _EditCommentatorState createState() => _EditCommentatorState();
}

class _EditCommentatorState extends State<EditCommentator> {
  File? image;
  Service? service;
...
//        leading: Icon(Icons.arrow_back),
        title: Text("Commentator Register"),
      ),
