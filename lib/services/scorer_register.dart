...
class ScorerRegister extends StatefulWidget {
  dynamic serviceId;

  ScorerRegister({this.serviceId});

  @override
  _ScorerRegisterState createState() => _ScorerRegisterState();
}

class _ScorerRegisterState extends State<ScorerRegister> {
  File? image;
  Service? service;
